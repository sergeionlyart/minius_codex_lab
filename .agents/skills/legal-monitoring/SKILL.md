...
description: >-
  Проведи полный правовой мониторинг уровня L3: общественная проблема, цель
  нормы, механизм, применение, данные, outcome/impact, причинность, root cause
  и измеримые рекомендации. Используй только для комплексной оценки
