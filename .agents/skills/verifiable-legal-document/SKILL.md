...
description: Собери проверяемый юридический документ: claim IDs, кликабельные внутренние ссылки на точные предложения/абзацы источников в приложениях, hashes и автоматический validation report. Используй для итогов высокой важности; не используй для неподтвержденного черновика.
---
