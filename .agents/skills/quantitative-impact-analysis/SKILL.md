...
description: Проанализируй статистические, административные и финансовые данные для юридической задачи: показатели, качество, сопоставимость, воспроизводимые расчеты, outcome/impact и осторожная причинность. Не используй при отсутствии достаточных данных для числового вывода.
---
