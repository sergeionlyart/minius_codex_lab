---
name: legal-drafting
description: Подготовь юридическую записку, заключение, проект нормы, письмо или отчет только на основе проверенного evidence ledger. Используй после evidence gate; не используй для первичного поиска источников.
---
