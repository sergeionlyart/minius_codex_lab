...
description: >-
  Сформируй воспроизводимый массив судебной/административной практики и
  проанализируй holdings, категории, согласованность и ограничения выборки.
  Используй при выводах о практике; не используй единичные решения как
