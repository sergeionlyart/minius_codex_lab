...
description: >-
  Создай или проверь реестр источников, версии, хэши, юридическую силу, точные
  локаторы и доказательственные фрагменты. Используй при импорте материалов и
  перед цитированием; не используй как замену содержательному анализу.
---
