---
name: matter-intake
description: Инициализируй новое юридическое дело или исследование: классификация данных, вопрос, дата актуальности, границы, продукт, план и evidence gate. Используй в начале нового поручения; не используй для уже полностью scoped задачи.
---
