---
name: legal-qa-audit
description: Проведи независимую юридическую и доказательственную проверку черновика: применимость норм, точность цитат, adverse authority, числа, overclaiming, ссылки, приватность и готовность. Используй перед выдачей; не используй как самоодобрение автора.
---
